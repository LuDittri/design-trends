      ...
      <div className="mb-16 md:mb-24">
        <div className="flex flex-col md:flex-row justify-between items-end relative gap-12 md:gap-0">
          <div className="max-w-[700px]">
            ...
            <p className="mt-8 md:mt-10 min-h-[144px] md:min-h-0 text-lg md:text-xl text-gray-500 dark:text-gray-400 leading-[1.8] tracking-wide font-light max-w-[420px] lg:max-w-[480px]">
