        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="md:col-span-6 lg:col-span-5">
            <h2 className="mb-4 flex items-center gap-2">
              <Logo className="h-8 w-auto text-black dark:text-white fill-current" aria-hidden="true" /> <span className="font-normal text-gray-400 dark:text-gray-600 text-2xl" aria-hidden="true">|</span> <span className="text-2xl font-bold tracking-tight text-black dark:text-white">Design Trends</span>
            </h2>
